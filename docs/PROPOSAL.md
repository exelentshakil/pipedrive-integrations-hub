...
code: https://github.com/exelentshakil/pipedrive-integrations-hub
portfolio: https://shakilhq.com

built a working proof of concept for your three projects this morning. it demonstrates native pipedrive v1 webhooks running under 150ms without zapier, two-way sinch sms with salesperson handover to you when high intent hits, instant tnz and australian spam act opt-out sync, and a normalized star schema pipeline ready for power bi desktop refresh.
